...
func NewOptions(fr filters.Registry, o proxy.ProxyOptions, routes ...*eskip.Route) *TestProxy {
...
func New(fr filters.Registry, routes ...*eskip.Route) *TestProxy {
	return NewOptions(fr, proxy.ProxyOptions{CloseIdleConnsPeriod: -time.Second}, routes...)
}
