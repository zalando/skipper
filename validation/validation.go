...
func StartValidation(address, certFile, keyFile string, filterRegistry filters.Registry, predicateSpecs []routing.PredicateSpec, mtr metrics.Metrics) error {
	if certFile == "" || keyFile == "" {
	...
	handler := newValidationHandler(filterRegistry, predicateSpecs, mtr)
...
func newValidationHandler(filterRegistry filters.Registry, predicateSpecs []routing.PredicateSpec, mtr metrics.Metrics) http.Handler {
