...
func AdaptToExtAuthRequest(req *http.Request, metadata *ext_authz_v3_core.Metadata, contextExtensions map[string]string, rawBody []byte, bodyTruncated bool) (*ext_authz_v3.CheckRequest, error) {
	...
	if bodyTruncated {
		headers["x-envoy-auth-partial-body"] = "true"
	} else {
		headers["x-envoy-auth-partial-body"] = "false"
	}
