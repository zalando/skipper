...
func TestLoopbackIfStatus(t *testing.T) {
	...
	br := eskip.MustParse(`LOOPBACK_404: Path("/loopback-404") -> inlineContent("404 Not Found") -> status(200) -> <shunt>`)
	br = append(br, eskip.MustParse(`LOOPBACK_500: Path("/loopback-500") -> inlineContent("500 Internal Error") -> status(200) -> <shunt>`)...)
