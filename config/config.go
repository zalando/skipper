...
type Config struct {
	...
	LuaPoolSize                     int            `yaml:"lua-pool-size"`
...
func NewConfig() *Config {
	...
	flag.IntVar(&cfg.LuaPoolSize, "lua-pool-size", 0, "sets hardcoded Lua pool size, if set else based on available memory seen by CGroup v1")
