...
func NewConfig() *Config {
	...
	flag.IntVar(&cfg.Oauth2TokeninfoCacheSize, "oauth2-tokeninfo-cache-size", 0, "sets the size of the tokeninfo cache")
	flag.DurationVar(&cfg.Oauth2TokeninfoCacheTTL, "oauth2-tokeninfo-cache-ttl", 0, "limits the lifetime of a cached tokeninfo which otherwise equals to the tokeninfo 'expires_in' field value")
