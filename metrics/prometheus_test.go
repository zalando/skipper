	...
	tests := []struct {
		...
		},
		{
			...
			expMetrics: []string{
				...
				`skipper_backend_combined_duration_seconds_sum 0.018`,
				`skipper_backend_combined_duration_seconds_count 2`,
				`skipper_backend_duration_seconds_bucket{host="",route="route1",zone="",le="0.005"} 0`,
				`skipper_backend_duration_seconds_bucket{host="",route="route1",zone="",le="0.01"} 0`,
				`skipper_backend_duration_seconds_bucket{host="",route="route1",zone="",le="0.025"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route1",zone="",le="0.05"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route1",zone="",le="0.1"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route1",zone="",le="0.25"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route1",zone="",le="0.5"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route1",zone="",le="1"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route1",zone="",le="2.5"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route1",zone="",le="5"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route1",zone="",le="10"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route1",zone="",le="+Inf"} 1`,
				`skipper_backend_duration_seconds_sum{host="",route="route1",zone=""} 0.015`,
				`skipper_backend_duration_seconds_count{host="",route="route1",zone=""} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route2",zone="",le="0.005"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route2",zone="",le="0.01"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route2",zone="",le="0.025"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route2",zone="",le="0.05"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route2",zone="",le="0.1"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route2",zone="",le="0.25"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route2",zone="",le="0.5"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route2",zone="",le="1"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route2",zone="",le="2.5"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route2",zone="",le="5"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route2",zone="",le="10"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="route2",zone="",le="+Inf"} 1`,
				`skipper_backend_duration_seconds_sum{host="",route="route2",zone=""} 0.003`,
				`skipper_backend_duration_seconds_count{host="",route="route2",zone=""} 1`,
			},
			expCode: http.StatusOK,
		},
		{
		...
		},
		{
			...
			expMetrics: []string{
				`skipper_backend_duration_seconds_bucket{host="host1",route="",zone="",le="0.005"} 0`,
				`skipper_backend_duration_seconds_bucket{host="host1",route="",zone="",le="0.01"} 0`,
				`skipper_backend_duration_seconds_bucket{host="host1",route="",zone="",le="0.025"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host1",route="",zone="",le="0.05"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host1",route="",zone="",le="0.1"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host1",route="",zone="",le="0.25"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host1",route="",zone="",le="0.5"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host1",route="",zone="",le="1"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host1",route="",zone="",le="2.5"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host1",route="",zone="",le="5"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host1",route="",zone="",le="10"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host1",route="",zone="",le="+Inf"} 1`,
				`skipper_backend_duration_seconds_sum{host="host1",route="",zone=""} 0.015`,
				`skipper_backend_duration_seconds_count{host="host1",route="",zone=""} 1`,
				`skipper_backend_duration_seconds_bucket{host="host2",route="",zone="",le="0.005"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host2",route="",zone="",le="0.01"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host2",route="",zone="",le="0.025"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host2",route="",zone="",le="0.05"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host2",route="",zone="",le="0.1"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host2",route="",zone="",le="0.25"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host2",route="",zone="",le="0.5"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host2",route="",zone="",le="1"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host2",route="",zone="",le="2.5"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host2",route="",zone="",le="5"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host2",route="",zone="",le="10"} 1`,
				`skipper_backend_duration_seconds_bucket{host="host2",route="",zone="",le="+Inf"} 1`,
				`skipper_backend_duration_seconds_sum{host="host2",route="",zone=""} 0.003`,
				`skipper_backend_duration_seconds_count{host="host2",route="",zone=""} 1`,
			},
			expCode: http.StatusOK,
		},
		{
			name: "Measuring backend zone latency without the zone option enabled should get nothing.",
			opts: metrics.Options{EnableBackendZoneMetrics: false},
			addMetrics: func(pm *metrics.Prometheus) {
				pm.MeasureBackendZone("eu-central-1a", time.Now().Add(-15*time.Millisecond))
			},
			expMetrics: []string{},
			expCode:    http.StatusOK,
		},
		{
			name: "Measuring backend zone latency with an empty zone should get nothing.",
			opts: metrics.Options{EnableBackendZoneMetrics: true},
			addMetrics: func(pm *metrics.Prometheus) {
				pm.MeasureBackendZone("", time.Now().Add(-15*time.Millisecond))
			},
			expMetrics: []string{},
			expCode:    http.StatusOK,
		},
		{
			name: "Measuring backend zone latency with the zone option enabled should get per-zone latency.",
			opts: metrics.Options{EnableBackendZoneMetrics: true},
			addMetrics: func(pm *metrics.Prometheus) {
				pm.MeasureBackendZone("eu-central-1a", time.Now().Add(-15*time.Millisecond))
				pm.MeasureBackendZone("eu-central-1b", time.Now().Add(-3*time.Millisecond))
			},
			expMetrics: []string{
				`skipper_backend_duration_seconds_bucket{host="",route="",zone="eu-central-1a",le="0.025"} 1`,
				`skipper_backend_duration_seconds_sum{host="",route="",zone="eu-central-1a"} 0.015`,
				`skipper_backend_duration_seconds_count{host="",route="",zone="eu-central-1a"} 1`,
				`skipper_backend_duration_seconds_bucket{host="",route="",zone="eu-central-1b",le="0.005"} 1`,
				`skipper_backend_duration_seconds_sum{host="",route="",zone="eu-central-1b"} 0.003`,
				`skipper_backend_duration_seconds_count{host="",route="",zone="eu-central-1b"} 1`,
			},
			expCode: http.StatusOK,
		},
		{
